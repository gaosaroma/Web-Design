// according to https://www.jq22.com/jquery-info21337 & https://www.jq22.com/jquery-info20964
// 做了部分改动
(function ($, window, document, undefined) {
    ...
    function Paging(element, options) {
        ...
        this.options = {
            currentNum: options.currentNum || 1, // 当前页码
    ...
    Paging.prototype = {
        ...
        createHtml: function () {
            let me = this;
            let content = [];
            let pageNum = me.options.currentNum;
        ...
        bindEvent: function () {
            ...
            me.element.on('click', 'button', function () {
                ...
                if (id === 'prePage') {
                    ...
                    if (pageNum !== me.options.totalNum) {
                        me.options.currentNum = me.options.totalNum;
                    }
                } else {
                    me.options.currentNum = num;
                }
                me.createHtml();
                if (me.options.callback) {
                    me.options.callback(me.options.currentNum);
                }
            });
        },
        dis: function () {
